...
@section('content')
	...
	@if(count($posts))
		...
		@endforeach
		@else
			<h1> :( </h1> No posts are tagged with that.</p></div><h3 style="text-align:center;">That's all we've got on {{ $topic }}.</h3><p style="text-align:center;">Pulsir is a hosted, beautiful and easy to use blogging platform. We take care of everything, no fees or ads on your content. <a href="/posts">Start writing today</a>, for free, forever.</p> </div>
	@endif
